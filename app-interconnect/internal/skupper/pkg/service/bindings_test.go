	...
	scenarios := []scenario{
		{
			...
			expected: &qdr.BridgeConfig{
				TcpConnectors: map[string]qdr.TcpEndpoint{
					"foo.target1@foo-pod-1:8080:9090": {
				...
				HttpConnectors: map[string]qdr.HttpEndpoint{
					"bar.target1@bar-pod-1:8080:8888": {
					...
					"bar.target1@bar-pod-1:9090:9999": {
					...
					"bar.target1@bar-pod-2:8080:8888": {
					...
					"bar.target1@bar-pod-2:9090:9999": {
					...
					"bar.target2@testservice:8080:8888": {
					...
					"bar.target2@testservice:9090:9999": {
					...
					"baz.target1@foo-pod-1:8080:9090": {
		...
		},
		{
			...
			expected: &qdr.BridgeConfig{
				...
				TcpListeners:  map[string]qdr.TcpEndpoint{},
				HttpConnectors: map[string]qdr.HttpEndpoint{
					"mc-service.target1@bar-pod-1:8080:8888": {
					...
					"mc-service.target1@bar-pod-2:8080:8888": {
					...
					"mc-service.target2@testservice:8080:9999": {
		...
		},
		{
			...
			expected: &qdr.BridgeConfig{
				...
				TcpListeners:  map[string]qdr.TcpEndpoint{},
				HttpConnectors: map[string]qdr.HttpEndpoint{
					"myevents.target1@foo-pod-1:8080:8888": {
		...
		},
		{
			...
			expected: &qdr.BridgeConfig{
				...
				TcpListeners:  map[string]qdr.TcpEndpoint{},
				HttpConnectors: map[string]qdr.HttpEndpoint{
					"special.target1@foo-pod-1:8080:8888": {
