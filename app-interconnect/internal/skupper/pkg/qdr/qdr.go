...
func InitialConfigSkupperRouter(id string, siteId string, version string, edge bool, helloAge int, options types.RouterOptions) RouterConfig {
	...
	extraFields := ExtraFieldsImpl{}
	sslFields := make(map[string]interface{})
	sslFields["protocols"] = "TLSv1.3 TLSv1.2"
	sslFields["ciphers"] = "ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384"

	extraFields.SetExtraFields(sslFields)
