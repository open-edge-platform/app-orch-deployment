	...
	return []SkupperImage{
		{
			...
			Repository: "https://github.com/open-edge-platform/app-orch-deployment/app-interconnect/internal/skupper-router",
		},
		{
			Name:       images.GetServiceControllerImageName(),
			SHA:        getSHAIfEnabled(enableSHA, images.GetServiceControllerImageName()),
			Repository: "https://github.com/open-edge-platform/app-orch-deployment/app-interconnect/internal/skupper",
		},
		{
