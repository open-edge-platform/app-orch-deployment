...
func (s *TestSuite)TestServiceLinkSuite() {
	var err error
...
func (s *TestSuite) TearDownSuite() {
	err := deploymentutils.DeleteAndRetryUntilDeleted(s.AdmClient, deploymentutils.WordpressAppName, 10, 10*time.Second)
	s.NoError(err)
