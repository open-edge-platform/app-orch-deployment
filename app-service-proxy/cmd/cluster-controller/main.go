...
import (
	...
	controller "github.com/open-edge-platform/app-orch-deployment/app-service-proxy/internal/cluster-controller"
...
func main() {
	...
	flag.StringVar(&gitCaCertFolder, "git-ca-cert-folder", "/tmp/ssl/certs/", "Folder containing the Git CA Cert file")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "27ca0722.orchestrator.io",
