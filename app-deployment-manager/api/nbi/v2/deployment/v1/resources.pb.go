...
const file_deployment_v1_resources_proto_rawDesc = "" +
	"\n" +
	"\x1ddeployment/v1/resources.proto\x12\rdeployment.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xea\t\n" +
	"\n" +
	"Deployment\x12\x17\n" +
	...
	"\fnetwork_name\x18\r \x01(\tB5\xe0A\x01\xbaH/r-\x10\x00\x18(2'^[a-z0-9]*[a-z0-9-]{0,18}[a-z0-9]{0,1}$R\vnetworkName\x12J\n" +
	...
	"\x06values\x18\x03 \x01(\v2\x17.google.protobuf.StructB\x03\xe0A\x01R\x06values\"\x84\x03\n" +
	"\x0eTargetClusters\x12T\n" +
	"\bapp_name\x18\x01 \x01(\tB9\xe0A\x01\xbaH3r1\x10\x00\x18(2+(^$)|^[a-z0-9][a-z0-9-]{0,38}[a-z0-9]{0,1}$R\aappName\x12\xbc\x01\n" +
	"\x06labels\x18\x02 \x03(\v2).deployment.v1.TargetClusters.LabelsEntryBy\xe0A\x01\xbaHs\x9a\x01p\"6r4\x10\x01\x18(2.(^$)|^[a-z0-9]([-_.=,a-z0-9/]{0,38}[a-z0-9])?$*6r4\x10\x01\x18(2.(^$)|^[a-z0-9]([-_.=,a-z0-9/]{0,38}[a-z0-9])?$R\x06labels\x12\"\n" +
	"\n" +
