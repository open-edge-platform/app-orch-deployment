...
type Deployment struct {
	...
	DeployId string `protobuf:"bytes,8,opt,name=deploy_id,json=deployId,proto3" json:"deploy_id,omitempty"`
	// The Override values can be used to override any of the base profile values based on Deployment scenario.
	OverrideValues []*OverrideValues `protobuf:"bytes,9,rep,name=override_values,json=overrideValues,proto3" json:"override_values,omitempty"`
	// Cluster labels on which we want to deploy the application.
	TargetClusters []*TargetClusters `protobuf:"bytes,10,rep,name=target_clusters,json=targetClusters,proto3" json:"target_clusters,omitempty"`
	// Status of the deployment.
	Status *Deployment_Status `protobuf:"bytes,11,opt,name=status,proto3" json:"status,omitempty"`
	// Application details.
	Apps []*App `protobuf:"bytes,12,rep,name=apps,proto3" json:"apps,omitempty"`
	// DEPRECATED - will remove in v2.
	// Name of the default DeploymentProfile to use when deploying this DeploymentPackage.
	// If no profileName is provided, use defaultProfileName from deployment package.
	DefaultProfileName string `protobuf:"bytes,13,opt,name=default_profile_name,json=defaultProfileName,proto3" json:"default_profile_name,omitempty"`
	...
	NetworkName    string           `protobuf:"bytes,15,opt,name=network_name,json=networkName,proto3" json:"network_name,omitempty"`
	ServiceExports []*ServiceExport `protobuf:"bytes,16,rep,name=service_exports,json=serviceExports,proto3" json:"service_exports,omitempty"`
	// Cluster labels/clusterID on which we want to deploy all the applications of the
	// deployment package
	AllAppTargetClusters *TargetClusters `protobuf:"bytes,17,opt,name=all_app_target_clusters,json=allAppTargetClusters,proto3" json:"all_app_target_clusters,omitempty"`
}
...
func (x *Deployment) GetPublisherName() string {
	if x != nil {
...
func (x *Deployment) GetDefaultProfileName() string {
	if x != nil {
...
// Details of API extension
type APIExtension struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Name of the API Extension.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Token for secure websocket connection between api-proxy and api-agent.
...
func (*APIExtension) Descriptor() ([]byte, []int) {
	return file_deployment_v1_resources_proto_rawDescGZIP(), []int{8}
}
...
func (x *APIExtension) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *UIExtension) Reset() {
	*x = UIExtension{}
	if protoimpl.UnsafeEnabled {
		mi := &file_deployment_v1_resources_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UIExtension) Descriptor() ([]byte, []int) {
	return file_deployment_v1_resources_proto_rawDescGZIP(), []int{9}
}
...
func (x *Deployment_Status) Reset() {
	*x = Deployment_Status{}
	if protoimpl.UnsafeEnabled {
		mi := &file_deployment_v1_resources_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_deployment_v1_resources_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xff, 0x0a, 0x0a, 0x0a,
	...
	,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2b, 0x0a, 0x04, 0x61, 0x70, 0x70, 0x73, 0x18, 0x0c,
	...
	,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x35, 0x0a, 0x07, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72,
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x42,
	0x03, 0xe0, 0x41, 0x03, 0x52, 0x07, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x22, 0x7a, 0x0a,
	0x0d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x4f,
	...
	0x7b, 0x30, 0x2c, 0x31, 0x7d, 0x24, 0x52, 0x07, 0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	0x18, 0x0a, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0xfb, 0x01, 0x0a, 0x0e, 0x4f, 0x76,
	0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x4f, 0x0a, 0x08,
	0x61, 0x70, 0x70, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x34,
	...
	0x2c, 0x31, 0x7d, 0x24, 0x52, 0x07, 0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x62, 0x0a,
	0x10, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x37, 0xe0, 0x41, 0x01, 0xba, 0x48, 0x31, 0x72,
	0x2f, 0x10, 0x00, 0x18, 0x3f, 0x32, 0x29, 0x28, 0x5e, 0x24, 0x29, 0x7c, 0x5e, 0x5b, 0x61, 0x2d,
	0x7a, 0x30, 0x2d, 0x39, 0x5d, 0x28, 0x5b, 0x2d, 0x61, 0x2d, 0x7a, 0x30, 0x2d, 0x39, 0x5d, 0x7b,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_deployment_v1_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_deployment_v1_resources_proto_goTypes = []interface{}{
	...
	(*APIExtension)(nil),               // 9: deployment.v1.APIExtension
	(*UIExtension)(nil),                // 10: deployment.v1.UIExtension
	(*Deployment_Status)(nil),          // 11: deployment.v1.Deployment.Status
	nil,                                // 12: deployment.v1.TargetClusters.LabelsEntry
	(*timestamppb.Timestamp)(nil),      // 13: google.protobuf.Timestamp
	(*structpb.Struct)(nil),            // 14: google.protobuf.Struct
}
var file_deployment_v1_resources_proto_depIdxs = []int32{
	13, // 0: deployment.v1.Deployment.create_time:type_name -> google.protobuf.Timestamp
	...
	11, // 3: deployment.v1.Deployment.status:type_name -> deployment.v1.Deployment.Status
	...
	14, // 7: deployment.v1.OverrideValues.values:type_name -> google.protobuf.Struct
	12, // 8: deployment.v1.TargetClusters.labels:type_name -> deployment.v1.TargetClusters.LabelsEntry
	11, // 9: deployment.v1.App.status:type_name -> deployment.v1.Deployment.Status
	11, // 10: deployment.v1.DeploymentInstancesCluster.status:type_name -> deployment.v1.Deployment.Status
	6,  // 11: deployment.v1.DeploymentInstancesCluster.apps:type_name -> deployment.v1.App
	11, // 12: deployment.v1.Cluster.status:type_name -> deployment.v1.Deployment.Status
...
func file_deployment_v1_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_deployment_v1_resources_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_deployment_v1_resources_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
