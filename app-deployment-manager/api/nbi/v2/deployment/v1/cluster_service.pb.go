...
const file_cluster_service_proto_rawDesc = "" +
	"\n" +
	"\x15cluster_service.proto\x12\rdeployment.v1\x1a\x1bbuf/validate/validate.proto\x1a\x0fresources.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"k\n" +
	...
	"\xe0A\x01\xbaH\x04\x1a\x02(\x00R\x06offset\"\x7f\n" +
	...
	"\n" +
	"GetCluster\x12 .deployment.v1.GetClusterRequest\x1a!.deployment.v1.GetClusterResponse\">\x82\xd3\xe4\x93\x028\x126/deployment.orchestrator.apis/v1/clusters/{cluster_id}BcZagithub.com/open-edge-platform/app-orch-deployment/app-deployment-manager/api/nbi/v2/deployment/v1b\x06proto3"
