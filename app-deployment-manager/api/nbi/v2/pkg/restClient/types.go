...
// APIExtension Details of API extension
type APIExtension struct {
	// Name Name of the API Extension.
	Name *string `json:"name,omitempty"`

	// Token Token for secure websocket connection between api-proxy and api-agent.
...
// GetAPIExtensionResponse Response message for GetAPIExtension method.
type GetAPIExtensionResponse struct {
	// ApiExtension Details of API extension
	ApiExtension APIExtension `json:"apiExtension"`
}
