...
type ClientInterface interface {
	// DeploymentServiceGetAPIExtension request
	DeploymentServiceGetAPIExtension(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	DeploymentServiceListUIExtensions(ctx context.Context, params *DeploymentServiceListUIExtensionsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) DeploymentServiceGetAPIExtension(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeploymentServiceGetAPIExtensionRequest(c.Server, name)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DeploymentServiceListUIExtensions(ctx context.Context, params *DeploymentServiceListUIExtensionsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeploymentServiceListUIExtensionsRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewDeploymentServiceGetAPIExtensionRequest generates requests for DeploymentServiceGetAPIExtension
func NewDeploymentServiceGetAPIExtensionRequest(server string, name string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/deployment.orchestrator.apis/v1/apiextensions/%s", pathParam0)
	if operationPath[0] == '/' {
...
func NewDeploymentServiceListUIExtensionsRequest(server string, params *DeploymentServiceListUIExtensionsParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/deployment.orchestrator.apis/v1/ui_extensions")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	// DeploymentServiceGetAPIExtensionWithResponse request
	DeploymentServiceGetAPIExtensionWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*DeploymentServiceGetAPIExtensionResponse, error)
	...
	DeploymentServiceListUIExtensionsWithResponse(ctx context.Context, params *DeploymentServiceListUIExtensionsParams, reqEditors ...RequestEditorFn) (*DeploymentServiceListUIExtensionsResponse, error)
}

type DeploymentServiceGetAPIExtensionResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *GetAPIExtensionResponse
}

// Status returns HTTPResponse.Status
func (r DeploymentServiceGetAPIExtensionResponse) Status() string {
...
func (r DeploymentServiceGetAPIExtensionResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
// DeploymentServiceGetAPIExtensionWithResponse request returning *DeploymentServiceGetAPIExtensionResponse
func (c *ClientWithResponses) DeploymentServiceGetAPIExtensionWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*DeploymentServiceGetAPIExtensionResponse, error) {
	rsp, err := c.DeploymentServiceGetAPIExtension(ctx, name, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeploymentServiceGetAPIExtensionResponse(rsp)
}
...
func (c *ClientWithResponses) DeploymentServiceListUIExtensionsWithResponse(ctx context.Context, params *DeploymentServiceListUIExtensionsParams, reqEditors ...RequestEditorFn) (*DeploymentServiceListUIExtensionsResponse, error) {
	rsp, err := c.DeploymentServiceListUIExtensions(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ParseDeploymentServiceGetAPIExtensionResponse parses an HTTP response from a DeploymentServiceGetAPIExtensionWithResponse call
func ParseDeploymentServiceGetAPIExtensionResponse(rsp *http.Response) (*DeploymentServiceGetAPIExtensionResponse, error) {
	...
	response := &DeploymentServiceGetAPIExtensionResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest GetAPIExtensionResponse
