...
// MockeryCoreV1Interface is an autogenerated mock type for the CoreV1Interface type
type MockeryCoreV1Interface struct {
	mock.Mock
}

// ComponentStatuses provides a mock function with given fields:
func (_m *MockeryCoreV1Interface) ComponentStatuses() v1.ComponentStatusInterface {
	ret := _m.Called()
...
func (_m *MockeryCoreV1Interface) ConfigMaps(namespace string) v1.ConfigMapInterface {
...
func (_m *MockeryCoreV1Interface) Endpoints(namespace string) v1.EndpointsInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) Events(namespace string) v1.EventInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) LimitRanges(namespace string) v1.LimitRangeInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) Namespaces() v1.NamespaceInterface {
	ret := _m.Called()
...
func (_m *MockeryCoreV1Interface) Nodes() v1.NodeInterface {
	ret := _m.Called()
...
func (_m *MockeryCoreV1Interface) PersistentVolumeClaims(namespace string) v1.PersistentVolumeClaimInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) PersistentVolumes() v1.PersistentVolumeInterface {
	ret := _m.Called()
...
func (_m *MockeryCoreV1Interface) PodTemplates(namespace string) v1.PodTemplateInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) Pods(namespace string) v1.PodInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) RESTClient() rest.Interface {
	ret := _m.Called()
...
func (_m *MockeryCoreV1Interface) ReplicationControllers(namespace string) v1.ReplicationControllerInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) ResourceQuotas(namespace string) v1.ResourceQuotaInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) Secrets(namespace string) v1.SecretInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) ServiceAccounts(namespace string) v1.ServiceAccountInterface {
	ret := _m.Called(namespace)
...
func (_m *MockeryCoreV1Interface) Services(namespace string) v1.ServiceInterface {
	ret := _m.Called(namespace)
...
// NewMockeryCoreV1Interface creates a new instance of MockeryCoreV1Interface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockeryCoreV1Interface(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockeryCoreV1Interface {
	mock := &MockeryCoreV1Interface{}
	mock.Mock.Test(t)
