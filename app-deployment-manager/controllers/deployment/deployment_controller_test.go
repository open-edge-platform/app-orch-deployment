...
// mockProjectResolver implements fleet.ProjectResolver for tests.
...
func (m *mockProjectResolver) ResolveProject(_ context.Context, projectID string) (string, string, error) {
	...
	BeforeEach(func() {
		...
		r = &Reconciler{
			...
			projectResolver: &mockProjectResolver{
				projects: map[string]resolvedProject{
					"a563356a-b4df-47bb-b620-aae2d74c5129": {
						orgName:     "mock-org-1",
