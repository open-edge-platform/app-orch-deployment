...
require (
	...
	github.com/open-edge-platform/app-orch-deployment/app-resource-manager/api/nbi/v2 v2.0.0-20260107021831-90236d75ab99 // indirect
...
exclude github.com/bufbuild/protovalidate-go v0.6.3
